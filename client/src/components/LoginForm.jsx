    ...
    return (
        <div className="h-screen w-screen flex bg-cover bg-center" style={{ backgroundImage: `url(${bgImage})` }}>
            ...
            <div className="w-1/2 h-full flex items-center justify-center bg-black/40 backdrop-blur-sm">
                <form className="w-full max-w-md px-6 text-white" onSubmit={handleLogin}>
                    ...
                    {/* Login Button */}
                    <button type="submit" disabled={!isValid} className="w-full py-2 rounded border border-white/30 text-white bg-purple-400/10 hover:bg-purple-300 hover:text-black transition">
                        Login
                    </button>
                    {serverError && <span className="text-red-500 text-sm mt-2 block">{serverError}</span>}
